package co.com.sanclemente.microservice.resolveEnigmaApi.config;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("co.com.sanclemente.microservice.resolveEnigmaApi.api"))
